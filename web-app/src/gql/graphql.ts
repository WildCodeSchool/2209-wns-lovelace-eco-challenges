...
export type GetChallengeByIdQuery = { __typename?: 'Query', challengeById: { __typename?: 'Challenge', id: string, challengeName: string, description: string, category: Array<Category>, level: Level, startsAt?: any | null, endAt?: any | null, teams?: Array<{ __typename?: 'Team', id: string, teamName: string, userToTeams?: Array<{ __typename?: 'UserToTeam', userRole: UserRole, user: { __typename?: 'AppUser', nickname: string } }> | null }> | null } };
