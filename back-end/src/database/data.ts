...
export const challengeSix = new Challenge("Eteignez (presque) tout!",Level.EASY,"Au boulot, à la maison, on éteint les lumières et, lorsque c'est possible, on ne laisse pas les équipements en veille.",[Category.ELECTRICITY, Category.LESS],undefined,undefined,"https://www.google.com/imgres?imgurl=https%3A%2F%2Fkoombackoffice.rezoloco.com%2Fimages%2Fkoom-cop21-eteindre-lumiere-ok-jpg&tbnid=gImHRpB2UBbGrM&vet=12ahUKEwj9toeE3JWAAxURoUwKHQvkCO4QMygKegUIARDjAQ..i&imgrefurl=https%3A%2F%2Fwww.koom.org%2Faction%2FEteindre-lumiere-piece&docid=cDMsH3c7u1ORRM&w=790&h=333&q=%C3%A9teindre%20lumi%C3%A8re&ved=2ahUKEwj9toeE3JWAAxURoUwKHQvkCO4QMygKegUIARDjAQ",
);
